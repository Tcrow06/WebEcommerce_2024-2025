...
<body>
    ...
    <div class="container-sm mt-5" style="max-width: 1000px; font-family: 'Poppins', sans-serif;">
        ...
        <div class="related-news mb-5" style="font-family: 'Poppins', sans-serif;">
            ...
            <ul>
                <li><a href="#" style=" text-decoration: none; color: #E693C7;">Mách Nàng Cách Xắn Tay Áo Vest Chuẩn Đẹp
                        Và Thời Thượng</a></li>
                <li><a href="#" style=" text-decoration: none; color: #E693C7;">Lưu Ngay Cách Giặt Áo Phao Không Bị Dồn
                        Bông Phải Biết</a></li>
                <li><a href="#" style=" text-decoration: none; color: #E693C7;">Gợi Ý 10 Cách Tẩy Mực Bút Lông Trên Áo
                        Đơn Giản Tại Nhà</a></li>
                <li><a href="#" style=" text-decoration: none; color: #E693C7;">Ngâm Quần Áo Mới Với Muối: 6 Lợi Ích
                        Không Tưởng Bạn Có Biết?</a></li>
                <li><a href="#" style=" text-decoration: none; color: #E693C7;">Giặt Áo Trắng Dính Cafe: Gợi Ý 9 Cách
                        Hữu Hiệu Nên Biết</a></li>
            </ul>
        </div>
    </div>
</body>
